...
public class ChooseAreaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(this,R.layout.item_layout, dataList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(currentLevel == LEVEL_PROVINCE) {
                    ...
                    String countName = countyList.get(position).getCountyName();
                    Intent intent = new Intent(ChooseAreaActivity.this, WeatherActivity.class);
                    intent.putExtra("county_name", countName);
                    intent.putExtra("province", selectedProvince.getProvinceName());
                    //保存到本地
                    prefs.edit().putString("province", selectedProvince.getProvinceName()).apply();
                    startActivity(intent);
                    finish();
                }
            }
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if("province".equals(type)) {
                    ...
                    result = Utility.hanleCitiesResponse(myWeatherDB, response, selectedProvince.getId());
